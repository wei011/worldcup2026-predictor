...
> 🗓️ **数据截至 2026-07-15 (UTC) 自动更新** · 本地随时复现：`python3 today.py --scorecard`

**已结束 101 场　·　方向命中 69/101 (68%)　·　平均 Brier score 0.434**（三分类瞎猜基准 0.667，越低越好）

| 日期 | 对阵 | 赛果 | 模型(胜/平/负) | 命中 |
|---|---|---|---|---|
| 07-06 | 墨西哥 vs 英格兰 | 2:3 | 29% / 28% / 42% | ✅ |
| 07-06 | 葡萄牙 vs 西班牙 | 0:1 | 12% / 21% / 66% | ✅ |
| 07-07 | 美国 vs 比利时 | 1:4 | 25% / 28% / 47% | ✅ |
| 07-07 | 阿根廷 vs 埃及 | 3:2 | 82% / 13% / 5% | ✅ |
| 07-07 | 瑞士 vs 哥伦比亚 | 0:0 | 27% / 28% / 45% | ❌ |
| 07-09 | 法国 vs 摩洛哥 | 2:0 | 56% / 25% / 19% | ✅ |
| 07-10 | 西班牙 vs 比利时 | 2:1 | 68% / 21% / 12% | ✅ |
| 07-11 | 挪威 vs 英格兰 | 1:2 | 19% / 26% / 55% | ✅ |
| 07-12 | 阿根廷 vs 瑞士 | 3:1 | 67% / 21% / 12% | ✅ |
| 07-14 | 法国 vs 西班牙 | 0:2 | 24% / 27% / 49% | ✅ |
